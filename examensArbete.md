...
| CAD | Computer aided design | Digitalt baserad design och skapande av tekniska ritningar som används inom konstruktion och arkitektur |
| --- | --------------------- | ------------------------------------------------------------------------------------------------------- |
| ``  | ``                    | ``                                                                                                      |

Innehåll

[1. Inledning**	**1](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.2et92p0)

[1.1 Bakgrund**	**1](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.tyjcwt)

[1.2 Syfte**	**1](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.3dy6vkm)

[1.3 Problemformulering**	**1](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.1t3h5sf)

[1.4 Avgränsningar och fokus**	**2](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.4d34og8)

[1.5 Metod/Arbetssätt**	**2](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.2s8eyo1)

[2. Teori**	**3](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.17dp8vu)

[3. Resultat**	**4](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.26in1rg)

[4. Diskussion**	**4](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.lnxbz9)

[5. Slutsatser**	**5](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.35nkun2)

[5.1 Rekommendationer**	**5](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.1ksv4uv)

[6. Referenslista**	**6](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.44sinio)

[Bilagor**	**7](https://docs.google.com/document/d/1rB4RMifaKQt4qLZmbUxpmn7p7X18O0-ECCcUns_QjTE/edit#heading=h.2jxsxqh)

Innehållsförteckningen i mallen är en autogenererad innehållsförteckning – och förutsätter att formatmallar används i alla rubriker

# 1. Inledning

Under min tid på LIA:n testade vi mycket med Cypress, men vi fick även tips om ett testverktyg som heter Playwright. Jag har därför valt att jämföra Cypress och Playwright med varandra. Huvudsaken till varför jag valde playwright är för det känns relevant att testa ett modernare testverktyg mot ett äldre.

I mitt projekt har jag delat in testningen i
